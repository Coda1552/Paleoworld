...
public class CephalaspisEntity extends AbstractFish {
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(CephalaspisEntity.class, EntityDataSerializers.INT);

    public CephalaspisEntity(EntityType<? extends AbstractFish> p_i48855_1_, Level p_i48855_2_) {
