...
public class HaikouichthysEntity extends AbstractFishEntity {
    ...
    public HaikouichthysEntity(EntityType<? extends AbstractFishEntity> p_i48855_1_, World p_i48855_2_) {
