...
public enum PWItemTier implements IItemTier {
    AMBER(2, 150, 6.0F, 2.0F, 25, () -> {
        return Ingredient.of(PWItems.AMBER.get());
    });
    ...
    private PWItemTier(int p_i48458_3_, int p_i48458_4_, float p_i48458_5_, float p_i48458_6_, int p_i48458_7_, Supplier<Ingredient> p_i48458_8_) {
