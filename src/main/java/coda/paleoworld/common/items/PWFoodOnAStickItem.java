...
public class PWFoodOnAStickItem <T extends Entity & ItemSteerable> extends Item {
    private final Supplier<EntityType<T>> canInteractWith;
    private final int consumeItemDamage;

    public PWFoodOnAStickItem(Item.Properties p_41307_, Supplier<EntityType<T>> p_41308_, int p_41309_){
        super(p_41307_);
