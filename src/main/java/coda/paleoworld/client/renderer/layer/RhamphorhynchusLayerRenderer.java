...
public class RhamphorhynchusLayerRenderer<T extends PlayerEntity> extends LayerRenderer<T, PlayerModel<T>> {
    private final RhamphorhynchusModel<RhamphorhynchusEntity> model = new RhamphorhynchusModel<>();

    public RhamphorhynchusLayerRenderer(IEntityRenderer<T, PlayerModel<T>> p_i50929_1_) {
        super(p_i50929_1_);
    }
    ...
    private void render(MatrixStack p_229136_1_, IRenderTypeBuffer p_229136_2_, int p_229136_3_, T p_229136_4_, float p_229136_5_, float p_229136_6_, float p_229136_7_, float p_229136_8_, boolean p_229136_9_) {
        ...
        if (compoundnbt.getString("id").equals(PWEntities.RHAMPHORHYNCHUS.get().getRegistryName().toString())) {
            ...
            IVertexBuilder ivertexbuilder = p_229136_2_.getBuffer(this.model.renderType(RhamphorhynchusRenderer.TEXTURE));
